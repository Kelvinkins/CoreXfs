...
namespace CoreXfs
{
    public unsafe class CDM : DeviceBase
    {
        ...
        public void Dispense(int amount, bool present = false, string currency = "CNY")
        {
            ...
            int hResult = Api.WFSAsyncExecute(hService, CDMDefinition.WFS_CMD_CDM_DISPENSE, ptr, 0, Handle, ref requestID);
        ...
        public void Present()
        {
            ...
            int hResult = Api.WFSAsyncExecute(hService, CDMDefinition.WFS_CMD_CDM_PRESENT, new IntPtr(&pos), 0, Handle, ref requestID);
            if (hResult != Definition.WFS_SUCCESS)
