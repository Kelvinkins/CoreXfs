...
namespace CoreXfs
{
    public static class Definition
    {
        ...
        #region Message-No
        public const int WFS_OPEN_COMPLETE = Constants.WM_USER + 1;
        public const int WFS_CLOSE_COMPLETE = Constants.WM_USER + 2;
        public const int WFS_LOCK_COMPLETE = Constants.WM_USER + 3;
        public const int WFS_UNLOCK_COMPLETE = Constants.WM_USER + 4;
        public const int WFS_REGISTER_COMPLETE = Constants.WM_USER + 5;
        public const int WFS_DEREGISTER_COMPLETE = Constants.WM_USER + 6;
        public const int WFS_GETINFO_COMPLETE = Constants.WM_USER + 7;
        public const int WFS_EXECUTE_COMPLETE = Constants.WM_USER + 8;
        public const int WFS_EXECUTE_EVENT = Constants.WM_USER + 20;
        public const int WFS_SERVICE_EVENT = Constants.WM_USER + 21;
        public const int WFS_USER_EVENT = Constants.WM_USER + 22;
        public const int WFS_SYSTEM_EVENT = Constants.WM_USER + 23;
        public const int WFS_TIMER_EVENT = Constants.WM_USER + 100;
        #endregion
    ...
    public unsafe struct WFSVERSION
    {
        ...
        public fixed char szDescription[Constants.WFSDDESCRIPTION_LEN + 1];
        public fixed char szSystemStatus[Constants.WFSDSYSSTATUS_LEN + 1];
